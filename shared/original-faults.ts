// الأعطال الأصلية المكتوبة يدوياً - 1479 عطل
// Original manually written faults

export interface OriginalFaultEntry {
  category: string;
  faultName: string;
...
export const ORIGINAL_FAULTS: OriginalFaultEntry[] = [
