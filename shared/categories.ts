...
export const INSPECTION_CATEGORIES = [
  ...
  { id: "quarter_panel_left", label: "الفخد يسار", labelEn: "Left Quarter Panel", section: "body" },
  { id: "quarter_panel_right", label: "الفخد يمين", labelEn: "Right Quarter Panel", section: "body" },
  ...
  { id: "fender_front", label: "المدقار الأمامي", labelEn: "Front Fender", section: "body" },
  { id: "fender_rear", label: "المدقار الخلفي", labelEn: "Rear Fender", section: "body" },
  ...
  { id: "lights_front", label: "الليتات الأمامية", labelEn: "Front Lights", section: "electric" },
  ...
  { id: "windows", label: "الزجاج والجامات", labelEn: "Glass & Windows", section: "interior" },
