...
const CATEGORIES: Record<string, { ar: string; en: string }> = {
  ...
  hood: { ar: 'البونيت', en: 'Hood' },
  trunk: { ar: 'الدبة', en: 'Trunk' },
  ...
  fender_front_left: { ar: 'المدقار الأمامي يسار', en: 'Front Left Fender' },
  fender_front_right: { ar: 'المدقار الأمامي يمين', en: 'Front Right Fender' },
  fender_rear_left: { ar: 'المدقار الخلفي يسار', en: 'Rear Left Fender' },
  fender_rear_right: { ar: 'المدقار الخلفي يمين', en: 'Rear Right Fender' },
  ...
  quarter_panel: { ar: 'الفخد', en: 'Quarter Panel' },
