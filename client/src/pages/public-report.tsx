    ...
    <div className="bg-white rounded-2xl shadow-xs border border-zinc-200 overflow-hidden" data-testid="vehicle-info-card">
      ...
      <div className="p-3 sm:p-4 grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {/* رقم الهيكل (VIN Card) */}
          <div className="rounded-2xl border border-zinc-200 bg-zinc-50/70 p-3 sm:p-4 text-center flex flex-col justify-between shadow-xs">
            <div className="flex items-center justify-between gap-2 mb-2">
              <div className="text-xs sm:text-sm font-bold text-zinc-950 font-arabic flex items-center gap-1.5">
                <PhosphorIcon name="barcode" weight="bold" size={18} className="text-zinc-700" />
                <span>لوحة رقم الهيكل (VIN)</span>
              </div>
              <span className="text-[10px] text-zinc-400 font-mono" dir="ltr">Chassis ID</span>
            </div>
            <div className="h-32 sm:h-40 rounded-xl overflow-hidden bg-white border border-zinc-200 flex items-center justify-center p-2 shadow-inner">
              {inspection.vinPhoto ? (
                ...
                <div className="flex flex-col items-center justify-center gap-2 text-center p-2">
                  <PhosphorIcon name="barcode" weight="bold" size={36} className="text-zinc-400" />
                  <div className="font-mono font-black text-xs sm:text-sm md:text-base text-zinc-900 tracking-wider break-all bg-zinc-100 px-3 py-1.5 rounded-lg border border-zinc-200" dir="ltr">
                    {inspection.vin || 'غير متوفر'}
                  </div>
                </div>
              )}
            </div>
            <div className="mt-2 text-[11px] font-mono font-bold text-zinc-600 bg-white py-1 px-2 rounded-lg border border-zinc-100 truncate" dir="ltr">
              {inspection.vin || '-'}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-zinc-200 bg-zinc-50/70 p-3 sm:p-4 text-center flex flex-col justify-between shadow-xs">
            <div className="flex items-center justify-between gap-2 mb-2">
              <div className="text-xs sm:text-sm font-bold text-zinc-950 font-arabic flex items-center gap-1.5">
                <PhosphorIcon name="gauge" weight="bold" size={18} className="text-zinc-700" />
                <span>قراءة العداد المعتمدة</span>
              </div>
              <span className="text-[10px] text-zinc-400 font-mono" dir="ltr">Odometer</span>
            </div>
            <div className="h-32 sm:h-40 rounded-xl overflow-hidden bg-white border border-zinc-200 flex flex-col items-center justify-center p-2 shadow-inner">
              {inspection.odometerPhoto ? (
                ...
                <div className="flex flex-col items-center justify-center gap-1 text-center p-2">
                  <div className="w-12 h-12 rounded-full bg-zinc-100 border border-zinc-200 flex items-center justify-center mb-1">
                    <PhosphorIcon name="gauge" weight="bold" size={26} className="text-zinc-700" />
                  </div>
                  <div className="font-mono font-black text-zinc-950 text-lg md:text-2xl">
            ...
            <div className="mt-2 text-xs font-mono font-bold text-zinc-900 bg-white py-1 px-2 rounded-lg border border-zinc-100 truncate">
